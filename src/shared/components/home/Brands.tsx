export const Brands = () => {
	...
	return (
		<div className='flex gap-15 py-[150px] px-10 flex-col items-center wrapper mx-auto'>
			<div>
				<h2 className='h2-s'>Brands I have worked with</h2>
			</div>
			<div className='w-full grid grid-cols-[repeat(5,minmax(200px,1fr))] auto-rows-min grid-rows-[repeat(2,min-content)] gap-2.5'>
				{brands.map((el) => (
					<div
						key={el.id}
